    ...
    private static String getTrackTypeString(Resources resources, @C.TrackType int trackType) {
        switch (trackType) {
            case C.TRACK_TYPE_VIDEO:
                return resources.getString(string.exo_track_selection_title_video);
            case C.TRACK_TYPE_AUDIO:
                return resources.getString(string.exo_track_selection_title_audio);
            case C.TRACK_TYPE_TEXT:
                return resources.getString(string.exo_track_selection_title_text);
            default:
